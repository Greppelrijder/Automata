...
from .ca_2d_4_sim_screen import CA2D_4_SimOptions

sys.path.append("..")
from models.boundry_conditions import BoundryConditions

class CA2D_4_PrepScreen(Screen):
    ...
    def __init__(self, root: tk.Tk) -> None:
        ...
        self.invalid_ruleset_warning = tk.Label(self.frame, fg="#880000", text="Ruleset must consist of 32 characters", font=custom_font3, justify="center", background="#8D8A8A")
    ...
    def parse_args(self, args) -> None:
        if isinstance(args, CA2D_4_SimOptions): # use presets that were passed through args 
    ...
    def on_create(self) -> None:
        ...
        sim_options = CA2D_4_SimOptions(size, ruleset_value, boundry_conditions, ca_name_value, alive_cell_color, dead_cell_color)
        execute(ScreenList.CA2D_4_Simulation, sim_options)