...
class CA2D_4_SimScreen(GridCA_SimScreen):


    @property
    def PREP_SCREEN(self) -> ScreenList:
        return ScreenList.CA2D_4_Preparation
    ...
    def setup_ca(self) -> None:
        self.ca = CA_2D(self.grid_size**2, self.ruleset, self.boundry_conditions, neighbours = 4)
    ...
    # commands
    def on_ca_canvas_clicked(self, args) -> None:
